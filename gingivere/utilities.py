...
class ConcatFeaturePipelines(object):
    """
    ...
    def __init__(self, *pipelines, **options):
        ...
        for p in pipelines:
            assert isinstance(p, FeaturePipeline)
...
class InputSource:
    ...
    def __init__(self, *transforms):
        self.pipeline = FeaturePipeline(InputSource(), *transforms) if len(transforms) > 0 else None
